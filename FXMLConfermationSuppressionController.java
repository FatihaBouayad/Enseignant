...
public class FXMLConfermationSuppressionController implements Initializable {
    ...
    ModeleEnseignantsStatic CurrentEnseignantStatic = new ModeleEnseignantsStatic();

    @FXML
    private void SupprimerCondidat() {
        try {
            String sql = "DELETE  FROM `enseignant`  WHERE IdEns ='" + CurrentEnseignantStatic.getIdEnseignant()+ "'";
         System.out.println("supprimer***********************************************->"+CurrentEnseignantStatic.getIdEnseignant());
   ...
   private void actualiser() throws IOException{
    ...
    private void ConfermationSuppression() throws SQLException, IOException{
         Alert alert = new Alert(Alert.AlertType.CONFIRMATION);
            ...
            alert.setContentText("Cette action va supprimer le Condidat N°{{ " + CurrentEnseignantStatic+ "}}");
